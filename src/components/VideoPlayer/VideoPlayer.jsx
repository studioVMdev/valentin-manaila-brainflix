				...
				<div className="video-player__container">
					...
					<div className="player">
						<div className="player__left-wrapper player-wrapper">
							<div className="player__play-button player-button"></div>
						</div>

						<div className="player__scrubbing player-wrapper">
							<div className="timeline">
								<div className="timeline__scrubbing player-button"></div>
						...
						<div className="player__right-wrapper player-wrapper">
							<div className="player__fullscreen-button player-button"></div>
							<div className="player__volume-button player-button"></div>
						</div>
					</div>
				</div>
